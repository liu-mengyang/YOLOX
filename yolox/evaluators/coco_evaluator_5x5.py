    ...
    def evaluate(
        ...
        for cur_iter, (imgs, _, info_imgs, ids) in enumerate(
            ...
            with torch.no_grad():
                ...
                # r_height = 160-height%160
                # r_width = 160-width%160
                # # print(imgs.shape)
                ...
                imgs_sub_14 = imgs[:,:,:int(sub_height),int(sub_width)*3:int(sub_width)*4]
                imgs_sub_15 = imgs[:,:,:int(sub_height),int(sub_width)*4:]
                ...
                imgs_sub_24 = imgs[:,:,int(sub_height):int(sub_height)*2,int(sub_width)*3:int(sub_width)*4]
                imgs_sub_25 = imgs[:,:,int(sub_height):int(sub_height)*2,int(sub_width)*4:]
                ...
                imgs_sub_34 = imgs[:,:,int(sub_height)*2:int(sub_height)*3,int(sub_width)*3:int(sub_width)*4]
                imgs_sub_35 = imgs[:,:,int(sub_height)*2:int(sub_height)*3,int(sub_width)*4:]
                imgs_sub_41 = imgs[:,:,int(sub_height)*3:,:int(sub_width)]
                imgs_sub_42 = imgs[:,:,int(sub_height)*3:int(sub_height)*4,int(sub_width):int(sub_width)*2]
                imgs_sub_43 = imgs[:,:,int(sub_height)*3:int(sub_height)*4,int(sub_width)*2:int(sub_width)*3]
                imgs_sub_44 = imgs[:,:,int(sub_height)*3:int(sub_height)*4,int(sub_width)*3:int(sub_width)*4]
                imgs_sub_45 = imgs[:,:,int(sub_height)*3:int(sub_height)*4,int(sub_width)*4:]
                imgs_sub_51 = imgs[:,:,int(sub_height)*4:,:int(sub_width)]
                imgs_sub_52 = imgs[:,:,int(sub_height)*4:,int(sub_width):int(sub_width)*2]
                imgs_sub_53 = imgs[:,:,int(sub_height)*4:,int(sub_width)*2:int(sub_width)*3]
                imgs_sub_54 = imgs[:,:,int(sub_height)*4:,int(sub_width)*3:int(sub_width)*4]
                imgs_sub_55 = imgs[:,:,int(sub_height)*4:,int(sub_width)*4:]
                ...
                outputs_sub_15 = model(imgs_sub_15)
                ...
                outputs_sub_25 = model(imgs_sub_25)
                ...
                outputs_sub_35 = model(imgs_sub_35)
                ...
                outputs_sub_45 = model(imgs_sub_45)
                outputs_sub_51 = model(imgs_sub_51)
                outputs_sub_52 = model(imgs_sub_52)
                outputs_sub_53 = model(imgs_sub_53)
                outputs_sub_54 = model(imgs_sub_54)
                outputs_sub_55 = model(imgs_sub_55)
                ...
                if decoder is not None:
                    ...
                    outputs_sub_15 = decoder(outputs_sub_15, dtype=outputs_sub_15.type())
                    ...
                    outputs_sub_25 = decoder(outputs_sub_25, dtype=outputs_sub_25.type())
                    ...
                    outputs_sub_35 = decoder(outputs_sub_35, dtype=outputs_sub_35.type())
                    ...
                    outputs_sub_45 = decoder(outputs_sub_45, dtype=outputs_sub_45.type())
                    outputs_sub_51 = decoder(outputs_sub_51, dtype=outputs_sub_51.type())
                    outputs_sub_52 = decoder(outputs_sub_52, dtype=outputs_sub_52.type())
                    outputs_sub_53 = decoder(outputs_sub_53, dtype=outputs_sub_53.type())
                    outputs_sub_54 = decoder(outputs_sub_54, dtype=outputs_sub_54.type())
                    outputs_sub_55 = decoder(outputs_sub_55, dtype=outputs_sub_55.type())
                ...
                outputs_sub_15 = postprocess(
                    outputs_sub_15, self.num_classes, self.confthre, self.nmsthre
                )
                for i in range(len(outputs_sub_15)):
                    if outputs_sub_15[i] is not None:
                        outputs_sub_15[i] = outputs_sub_15[i].cpu()
                        outputs_sub_15[i][:, 0] += sub_width*4
                        outputs_sub_15[i][:, 2] += sub_width*4
                        
                        if outputs_sub_11[i] is not None:
                            outputs_sub_11[i] = torch.cat((outputs_sub_11[i],outputs_sub_15[i]),0)
                        else:
                            outputs_sub_11[i] = outputs_sub_15[i]
                ...
                outputs_sub_25 = postprocess(
                    outputs_sub_25, self.num_classes, self.confthre, self.nmsthre
                )
                for i in range(len(outputs_sub_25)):
                    if outputs_sub_25[i] is not None:
                        outputs_sub_25[i] = outputs_sub_25[i].cpu()
                        outputs_sub_25[i][:, 0] += sub_width*4
                        outputs_sub_25[i][:, 1] += sub_height
                        outputs_sub_25[i][:, 2] += sub_width*4
                        outputs_sub_25[i][:, 3] += sub_height
                        
                        if outputs_sub_11[i] is not None:
                            outputs_sub_11[i] = torch.cat((outputs_sub_11[i],outputs_sub_25[i]),0)
                        else:
                            outputs_sub_11[i] = outputs_sub_25[i]
                ...
                outputs_sub_35 = postprocess(
                    outputs_sub_35, self.num_classes, self.confthre, self.nmsthre
                )
                for i in range(len(outputs_sub_35)):
                    if outputs_sub_35[i] is not None:
                        outputs_sub_35[i] = outputs_sub_35[i].cpu()
                        outputs_sub_35[i][:, 0] += sub_width*4
                        outputs_sub_35[i][:, 1] += sub_height*2
                        outputs_sub_35[i][:, 2] += sub_width*4
                        outputs_sub_35[i][:, 3] += sub_height*2
                        
                        if outputs_sub_11[i] is not None:
                            outputs_sub_11[i] = torch.cat((outputs_sub_11[i], outputs_sub_35[i]),0)
                        else:
                            outputs_sub_11[i] = outputs_sub_35[i]
                ...
                outputs_sub_45 = postprocess(
                    outputs_sub_45, self.num_classes, self.confthre, self.nmsthre
                )
                for i in range(len(outputs_sub_45)):
                    if outputs_sub_45[i] is not None:
                        outputs_sub_45[i] = outputs_sub_45[i].cpu()
                        outputs_sub_45[i][:, 0] += sub_width*4
                        outputs_sub_45[i][:, 1] += sub_height*3
                        outputs_sub_45[i][:, 2] += sub_width*4
                        outputs_sub_45[i][:, 3] += sub_height*3
                        
                        if outputs_sub_11[i] is not None:
                            outputs_sub_11[i] = torch.cat((outputs_sub_11[i], outputs_sub_45[i]),0)
                        else:
                            outputs_sub_11[i] = outputs_sub_45[i]
                outputs_sub_51 = postprocess(
                    outputs_sub_51, self.num_classes, self.confthre, self.nmsthre
                )
                for i in range(len(outputs_sub_51)):
                    if outputs_sub_51[i] is not None:
                        outputs_sub_51[i] = outputs_sub_51[i].cpu()
                        outputs_sub_51[i][:, 1] += sub_height*4
                        outputs_sub_51[i][:, 3] += sub_height*4
                        
                        if outputs_sub_11[i] is not None:
                            outputs_sub_11[i] = torch.cat((outputs_sub_11[i],outputs_sub_51[i]),0)
                        else:
                            outputs_sub_11[i] = outputs_sub_51[i]
                outputs_sub_52 = postprocess(
                    outputs_sub_52, self.num_classes, self.confthre, self.nmsthre
                )
                for i in range(len(outputs_sub_52)):
                    if outputs_sub_52[i] is not None:
                        outputs_sub_52[i] = outputs_sub_52[i].cpu()
                        outputs_sub_52[i][:, 0] += sub_width
                        outputs_sub_52[i][:, 1] += sub_height*4
                        outputs_sub_52[i][:, 2] += sub_width
                        outputs_sub_52[i][:, 3] += sub_height*4
                        
                        if outputs_sub_11[i] is not None:
                            outputs_sub_11[i] = torch.cat((outputs_sub_11[i], outputs_sub_52[i]),0)
                        else:
                            outputs_sub_11[i] = outputs_sub_52[i]
                outputs_sub_53 = postprocess(
                    outputs_sub_53, self.num_classes, self.confthre, self.nmsthre
                )
                for i in range(len(outputs_sub_53)):
                    if outputs_sub_53[i] is not None:
                        outputs_sub_53[i] = outputs_sub_53[i].cpu()
                        outputs_sub_53[i][:, 0] += sub_width*2
                        outputs_sub_53[i][:, 1] += sub_height*4
                        outputs_sub_53[i][:, 2] += sub_width*2
                        outputs_sub_53[i][:, 3] += sub_height*4
                        
                        if outputs_sub_11[i] is not None:
                            outputs_sub_11[i] = torch.cat((outputs_sub_11[i], outputs_sub_53[i]),0)
                        else:
                            outputs_sub_11[i] = outputs_sub_53[i]
                outputs_sub_54 = postprocess(
                    outputs_sub_54, self.num_classes, self.confthre, self.nmsthre
                )
                for i in range(len(outputs_sub_54)):
                    if outputs_sub_54[i] is not None:
                        outputs_sub_54[i] = outputs_sub_54[i].cpu()
                        outputs_sub_54[i][:, 0] += sub_width*3
                        outputs_sub_54[i][:, 1] += sub_height*4
                        outputs_sub_54[i][:, 2] += sub_width*3
                        outputs_sub_54[i][:, 3] += sub_height*4
                        
                        if outputs_sub_11[i] is not None:
                            outputs_sub_11[i] = torch.cat((outputs_sub_11[i], outputs_sub_54[i]),0)
                        else:
                            outputs_sub_11[i] = outputs_sub_54[i]
                outputs_sub_55 = postprocess(
                    outputs_sub_55, self.num_classes, self.confthre, self.nmsthre
                )
                for i in range(len(outputs_sub_55)):
                    if outputs_sub_55[i] is not None:
                        outputs_sub_55[i] = outputs_sub_55[i].cpu()
                        outputs_sub_55[i][:, 0] += sub_width*4
                        outputs_sub_55[i][:, 1] += sub_height*4
                        outputs_sub_55[i][:, 2] += sub_width*4
                        outputs_sub_55[i][:, 3] += sub_height*4
                        
                        if outputs_sub_11[i] is not None:
                            outputs_sub_11[i] = torch.cat((outputs_sub_11[i], outputs_sub_55[i]),0)
                        else:
                            outputs_sub_11[i] = outputs_sub_55[i]
